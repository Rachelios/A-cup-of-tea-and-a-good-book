select brand_url, series_url, model_url, gender,
...
where is_404 = false and out_of_stock = false 
  and api_only = false and brand_url <> '' and series_url <> '' and model_url <> '' and gender <> 0
group by brand_url, series_url, model_url, gender, 5